        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.text_note_title),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("Tit"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.text_note_text),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("te"), closeSoftKeyboard());

        pressBack();

        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.text_note_text), withText("te"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.coordinatorlayout.widget.CoordinatorLayout")),
                                        1),
                                2),
                        isDisplayed()));
        appCompatEditText9.perform(replaceText("text"));
